...
- [UCE tracker ownership](uce-tracker-ownership.md) — resources spawned from shared views belong to the clicking user, not the command invoker; test poster ≠ clicker
